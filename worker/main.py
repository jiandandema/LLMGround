...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default="facebook/opt-125m", help='模型名称')
    parser.add_argument('--served-model-name', nargs='+', default=["test"], type=str, help='服务的模型名称列表')
    parser.add_argument('--controller-url', nargs='+', type=str, default=['http://127.0.0.1:8000'], help='动态负载均衡控制器地址')
